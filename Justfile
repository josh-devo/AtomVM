...
wasi-test:
    ...
    elixirc --no-docs --no-debug-info calculator.ex gen_server_test.ex json_validator.ex
    ...
    TESTS=(simple_test display_test math_test atom_test list_test test_zlib_compress spawn_fun1 test_ets calculator Elixir.Calculator Elixir.GenServerTest Elixir.JsonValidator)
    PASSED=0
    FAILED=0
